      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-sm md:text-xl text-muted-foreground max-w-[600px] text-justify">
            ...
            <div className="flex gap-4 pt-4">
              <Link href="https://github.com/valentelucass" target="_blank" rel="noopener noreferrer">
                <Button
                  variant="ghost"
                  size="icon"
                  className="rounded-full bg-zinc-800/80 hover:bg-zinc-700 text-slate-400 hover:text-white"
                >
              ...
              <a href="https://wa.me/5584994187843" target="_blank" rel="noopener noreferrer">
                <Button
                  variant="ghost"
                  size="icon"
                  className="rounded-full bg-zinc-800/80 hover:bg-zinc-700 text-slate-400 hover:text-white"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5">
                    <path d="M16 3C9.372 3 4 8.372 4 15c0 2.385.832 4.584 2.236 6.364L4 29l7.09-2.236A12.94 12.94 0 0 0 16 27c6.628 0 12-5.372 12-12S22.628 3 16 3z"/>
                  </svg>
              ...
              <div className="relative aspect-square rounded-xl overflow-hidden border border-zinc-800">
                ...
                <div className="absolute bottom-0 left-0 w-full p-6">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm md:text-base font-medium">Aberto a oportunidades profissionais</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex justify-center mt-16">
            <GlassmorphicCard>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-zinc-800 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5 text-cyan-400">
                      <path d="M16 3C9.372 3 4 8.372 4 15c0 2.385.832 4.584 2.236 6.364L4 29l7.09-2.236A12.94 12.94 0 0 0 16 27c6.628 0 12-5.372 12-12S22.628 3 16 3z"/>
                    </svg>
                  </div>
                  <div>
                    <div className="text-sm text-zinc-500">WhatsApp</div>
                    <div className="font-medium"><a href="https://wa.me/5584994187843" target="_blank" rel="noopener noreferrer">wa.me/5584994187843</a></div>
                  </div>
                </div>
              </div>
